...
class TestResultsViewController:
    ...
    def setupUI(self):
        ...
        self._view.test_result_correct.setText(f"result ok: {self._results.get('correct')}")
        self._view.test_result_flipped.setText(f"result fl: {self._results.get('flipped')}")
        self._view.test_result_incorrect.setText(f"result bad: {self._results.get('incorrect')}")
