...
class MainWindowController:
    ...
    def add_lesson_view(self, lesson_name):
        self.lessonDetailView = LessonDetailView()
        self.lessonDetailViewController = LessonDetailViewController(self.lessonDetailView, self.stacked_widget, lesson_name)
